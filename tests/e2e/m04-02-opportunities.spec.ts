...
test('M04-02.A07/A08/A15 opportunity detail tabs and reason-required decision preserve missing states',async({page})=>{
  ...
  await expect(page.getByText('评分规则由 M04-03 交付')).toBeVisible();
