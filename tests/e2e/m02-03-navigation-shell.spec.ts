...
async function allow(page: any, shell: 'member' | 'organization_admin' | 'platform_admin') {
  ...
  await page.route('**/api/v1/org/admin/workspaces', (route: any) => route.fulfill({ json: envelope([{ id: '00000000-0000-4000-8000-000000000104', name: 'Shell Contract Workspace', slug: 'shell-contract', status: 'active', member_count: 0, version: 1 }]) }));
