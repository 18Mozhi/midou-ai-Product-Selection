...
const reviewPath = "design-plans/ui-phase-2-2026-09-07/action-reviews/P42.json";
const normalized = (file) => readFileSync(file, "utf8").replaceAll("\r\n", "\n");
const digest = (value) => createHash("sha256").update(value).digest("hex");

test("P42 action map accounts for the organization detail and shared reason flow without runtime acceptance", () => {
  ...
  assert.equal(summary.pageId, "P42");
