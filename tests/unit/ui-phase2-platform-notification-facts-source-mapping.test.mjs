...
const file = "apps/web/src/components/PlatformNotificationFacts.vue";

test("notification facts directory links map to the personal center and platform governance routes", () => {
  ...
  const rows = audit.records.filter(
    (record) =>
      ...
      record.claim.includes("PN57-FACTS-CURRENT-") &&
      record.temporalScope !== "historical",
  );
  const expectedIds = ["9c897f6109cc18aa.1", "b57765191bc5cdc3.1"].map(
