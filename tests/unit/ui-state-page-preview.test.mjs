...
test("P72 uses the production Vue component unchanged for C review", async () => {
...
test("P72 C view removes the decorative orbit and keeps the internal boundary", async () => {
