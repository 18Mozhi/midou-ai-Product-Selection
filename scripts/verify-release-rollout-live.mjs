...
import { ReleaseRolloutService } from "../apps/api/dist/release-rollout-service.js";
...
async function migrate() {
  for (const name of ["0007_m00_08_deployment_releases.up.sql", "0026_release_rollout_m07_05.up.sql"]) {
...
try {
  ...
  await cleanup(); console.log(JSON.stringify({ module:"M07-05",status:"passed",mysql:runtime.version,same_host_candidate:true,verified_transition:"passed",missing_metric_fail_closed:"passed",audit_correlation:"passed",cleanup:"passed",request_id:requestId,trace_id:traceId },null,2));
