...
async function main() {
  ...
  assert.equal(
    existsSync("design-plans/ui-phase-2-2026-09-07/P44-CAPTURE-UNIT-RESULT.json"),
    false,
    "P44 full-unit report already exists; do not rerun or overwrite this capture",
  );
  ...
  const report = {
    kind: "P44-capture-full-unit-closure",
    startedAt,
  ...
  await writeFile(
    "design-plans/ui-phase-2-2026-09-07/P44-CAPTURE-UNIT-RESULT.json",
