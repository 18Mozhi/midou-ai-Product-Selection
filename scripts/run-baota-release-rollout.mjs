...
try {
  ...
  const migrations = [];
  for (const name of ["0026_release_rollout_m07_05.up.sql", "0027_release_write_probe_m07_05.up.sql", "0027a_release_rollout_attempts_m07_05.up.sql", "0032_mysql_resilience_m08_03.up.sql", "0032a_compact_release_write_probe_m08_03.up.sql", "0033_file_resilience_m08_04.up.sql", "0034_crawler_scheduler_m08_05.up.sql"]) migrations.push(await applyMigration(pool, releaseRoot, name));
