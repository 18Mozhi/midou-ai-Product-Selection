...
async function main() {
  ...
  assert.equal(
    existsSync("design-plans/ui-phase-2-2026-09-07/P43-LIFECYCLE-r2-CAPTURE-UNIT-RESULT.json"),
    false,
    "P43-LIFECYCLE-r2 full-unit report already exists; do not rerun or overwrite this capture",
  );
  ...
  const report = {
    kind: "P43-LIFECYCLE-r2-capture-full-unit-closure",
    startedAt,
    ...
    fixtureCleanup: tap.split(/\r?\n/).filter((line) => line.includes("isolated_format_fixture")),
    stderr: Buffer.concat(stderr).toString("utf8"),
  };
  await writeFile(
    "design-plans/ui-phase-2-2026-09-07/P43-LIFECYCLE-r2-CAPTURE-UNIT-RESULT.json",
