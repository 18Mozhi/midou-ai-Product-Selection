...
const baselineCommit = "7a147e6f65083cd63042a9c6b2d0a03ac8968b87";
    ...
    JSON.stringify(
      {
        ...
        boundary:
          "Actual child with isolated fixtures. Only mobile filter region implemented; desktop/request pixels compared to pre-change SFC. Not parent/API/permission/production or other visual approval.",
        baselineCommit,
