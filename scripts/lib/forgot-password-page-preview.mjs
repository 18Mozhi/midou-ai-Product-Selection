...
export const forgotPasswordReviewCss="design-plans/ui-phase-2-2026-09-07/implementation/forgot-password-page-preview.css";
export const forgotPasswordPageSources=[forgotPasswordReviewCss,"scripts/lib/forgot-password-page-preview.mjs","apps/web/src/components/LocalIdentity.vue"];
...
export function forgotPasswordPagePlugin(){return {name:"p04-actual-vue-review",enforce:"pre",transform(source,id){const file=id.replaceAll("\\","/"),target=path.resolve("apps/web/src/components/LocalIdentity.vue").replaceAll("\\","/");if(file===target)return {code:previewForgotPasswordPage(source),map:null};},transformIndexHtml(html){return html.replace("<body>",'<body class="p04-review">').replace("</head>",`<link rel="stylesheet" href="/@fs/${path.resolve(forgotPasswordReviewCss).replaceAll("\\","/")}"></head>`);}};}
