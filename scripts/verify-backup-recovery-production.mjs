...
if (manifest.targets?.mysql?.rpoMinutes !== 15 || manifest.targets?.mysql?.rtoMinutes !== 240 || manifest.recoveryDrill?.isolated !== true) fail("recovery_objective_invalid", "RPO RTO or isolated drill contract drifted");
