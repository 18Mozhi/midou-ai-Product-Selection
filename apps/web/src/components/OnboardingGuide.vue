...
const pages=[
 {eyebrow:'FROM SIGNAL TO ACTION',title:'把市场变化，变成今天的行动',copy:'ai选品 将来源证据、机会判断与团队任务串在同一个工作范围里。',mark:'↗',points:['变化附带来源与新鲜度','机会保留评分依据','行动进入可追踪任务']},
