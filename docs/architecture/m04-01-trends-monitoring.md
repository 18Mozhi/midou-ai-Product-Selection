...
商品型 Google 频道和自动电商来源直接建立证据化机会；普通新闻、数据和社区来源只有命中用户规则才建立机会。Amazon 商品网址中的真实 ASIN会建立“等待首次快照”的竞品，新机会会建立“尚无真实报价”的找货记录。价格、排名、评论、供应商、MOQ 或报价未采集到时保持缺失，不填 0 或演示数据。
