...
页面信息合同沿用账号、邮箱验证、密码重置、MFA 和安全设置的真实流程；当前视觉依据为 `design-plans/ui-redesign-2026-09-05/` 的公开入口页面。实现使用信号账页的桌面双栏、单一朱砂主 CTA、就近状态反馈和 390px 单栏折叠，不把历史参考图中的第三方登录按钮误做成已支持能力。
