...
桌面布局取核心图 01、04–10 的组织/工作区顶栏、深海蓝状态卡、结论优先详情和证据 CTA；移动布局取概念图 53、54，390px 下状态指标与候选卡转单列、关键证据和决策动作不隐藏。页面只展示业务进度、候选比较、受阻原因与下一步，不展示生产验收阈值或内部状态码。404 继续遵循概念图 72，状态不仅依赖颜色。
