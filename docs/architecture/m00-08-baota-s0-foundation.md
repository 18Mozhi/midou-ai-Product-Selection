...
S0 模板包含宝塔网站、Node API、Node Worker、Python Crawler、MySQL 5.7、Redis、手动发布门禁与备份任务八个对象。manifest 永久区分模板与真实部署；M07-03 完成现场创建和签发后当前为 `productionDeployed=true`。禁止 systemd、独立 PM2、宿主 crontab和屏外 Docker Compose 承载生产能力。
