...
1. 在宝塔受限发布任务备份 MySQL，按发布清单执行 `database/migrations/0017a_trends_m04_01.up.sql`、`0043_trend_rule_collection_schedule.up.sql` 与 `0064_governed_workflow_confirmations.up.sql`；迁移兼容 MySQL 5.7、`utf8mb4`，不得使用 root 运行常驻服务。
