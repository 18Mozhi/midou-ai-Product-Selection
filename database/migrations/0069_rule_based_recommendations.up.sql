ALTER TABLE `trend_monitoring_rules`
  ADD COLUMN `recommendation_min_source_count` TINYINT UNSIGNED NOT NULL DEFAULT 1
    AFTER `collection_interval_minutes`;

UPDATE `opportunities` o
SET o.recommendation_status='recommend',o.version=o.version+1,o.updated_at=UTC_TIMESTAMP(3)
