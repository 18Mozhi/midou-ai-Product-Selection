...
后续批次09：本包保持`7aad0879`捕获时的图、manifest和手机批准；按钮验证器新增`--primary`，编辑CSS及加载来源已有演进，旧源码指纹不再全部匹配当前。默认取消144项继续回归；新的保存/发布图见[主按钮包](../primary-button-review-r1/README.md)，不扩大本包批准。
