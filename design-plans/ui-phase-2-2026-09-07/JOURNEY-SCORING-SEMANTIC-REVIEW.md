...
后续P16 r2已按新规则扩展338图，当前十处/8组源码映射不变；40个代表适用状态槽已有引用、8导航禁用/忙碌不适用，恢复主次分支已核对。用户只批准整体布局。见[控件审核](P16-CONTROL-STATE-REVIEW.md)、[图册](design/journey-direction-c/README.md)、[批准范围](P16-C-R2-LAYOUT-APPROVAL.md)与合同第9节。本页下方P16旧状态为历史，P17未改。 新增[字段审核](P16-FIELD-STATE-REVIEW.md)，5个源绑定的8控件变体已有状态图与隔离交互验证，生产未改。
