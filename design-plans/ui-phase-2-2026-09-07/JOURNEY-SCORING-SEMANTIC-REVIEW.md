...
后续P16 r2已按新规则重拍152图、恢复当前十处/8组源码映射，创建及保存两个代表动作共12状态槽已有明确引用；用户只批准整体布局。见[图册](design/journey-direction-c/README.md)、[批准范围](P16-C-R2-LAYOUT-APPROVAL.md)与合同第9节。本页下方P16旧状态为历史，P17未改。
