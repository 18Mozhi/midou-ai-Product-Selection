...
- 1610条来源绑定 / 879个唯一文件，漂移0；PNG指纹漂移0，未列入清单PNG 0；图册内8980个本地链接已核对。
...
| P26 | 通知中心 · `/notifications` | [规格](page-specs/P26.md) | [notification-controls](design/notification-controls-direction-c/README.md) · [notification](design/notification-direction-c/README.md) | 相关稿待审；整页/全动作未证明 |
