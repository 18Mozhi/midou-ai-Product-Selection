...
2026-09-10 P28操作增量：[创建、下载与刷新回执](P28-OPERATION-OWNERSHIP-REVIEW.md)。24源/24真实Vue双端场景；旧创建回执和下载错误不覆盖后来视图，已启动下载继续完成，busy/refreshing在途早退。并发重建应打开最后发起、最先完成还是不自动打开，已请用户选择；本批不改regenerate。RP-G02、跨范围与完整视觉/服务/生产仍待。

2026-09-10 P28读取修复：[批次及详情归属](P28-READ-OWNERSHIP-REVIEW.md)。24源回归与22真实Vue双端场景通过；RP-G01中的读取批次、详情晚到、关闭/清参数/销毁已局部修复，不关闭其完整跨范围/全组合验收。源14候选/10动作/1接线、0输入/1窗与模板不变，接口/写入/下载未改，未部署；下方“读取归属仍待”为历史范围记录。
...
| 文件 | 行 | sig | 语义动作或弹窗 |
| --- | --- | --- | --- |
| AR | 474 | d27de6387d58944c.1 | AR-CREATE；打开空表单 |
| AR | 504 | 6a22c249121aeb4d.1 | AR-LOAD；错误重读 |
| AR | 549 | 5b19eec3cd4a60d0.1 | AR-DETAIL；rule深链→GET |
| AR | 550 | 110dd4ce491d067b.1 | AR-EDIT；rule/action编辑 |
| AR | 551 | 7d3171303da98576.1 | AR-STATUS；暂停/恢复 |
| AR | 557 | 08d127ded2ba2429.1 | D-AR-EXECUTIONS；原生模态 |
| AR | 557 | ae7f95f10a94c968.1 | AR-DETAIL-CLOSE；Escape |
| AR | 564 | aef9c00aea0c46b8.1 | AR-DETAIL-CLOSE；关闭按钮 |
| AR | 573 | 573d41c8d777efee.1 | AR-TASK；真实人工任务链接 |
| AR | 577 | eb58830acad203db.1 | AR-NOTIFICATION；触发通知 |
| AR | 586 | 1c008f867673db60.1 | AR-TECH；执行错误/资源标识 |
| AR | 593 | a6561f91cc94ec7b.1 | D-AR-EDITOR；新建/编辑两变体 |
| AR | 593 | 35756ebc6c836998.1 | AR-EDITOR-CLOSE；Escape |
| AR | 598 | 926c2e079c31814f.1 | AR-SAVE；表单submit |
| AR | 603 | 742531071607ff73.1 | AR-TEMPLATE；三模板草稿 |
| AR | 712 | 3e0160425e8092a0.1 | AR-SAMPLE；预览来源链接 |
| AR | 724 | 2354c8e95ace6cd1.1 | AR-EDITOR-CLOSE；取消 |
| AR | 725 | 180c3b124eda84e8.1 | AR-PREVIEW；只读POST |
| AR | 727 | ea72a6477a8776b1.1 | AR-SAVE；新建/编辑提交按钮 |
| RP | 379 | 97351e6d4fd4cc45.1 | RP-CREATE；CSV入队 |
| RP | 382 | 333b03bc402fcd48.1 | RP-TYPE；三类报表URL |
| RP | 394 | 1c008f867673db60.1 | RP-TECH；请求关联标识 |
| RP | 417 | 97ed4772fb320d6c.1 | RP-LOAD；错误重读 |
| RP | 486 | aa7c04ce54cf7cb5.1 | RP-REFRESH；后台保留显示 |
| RP | 489 | 48c7e8b38910554f.1 | RP-TASKS；导出任务视图 |
| RP | 509 | 6008f8ab717efc14.1 | RP-DOWNLOAD；有效文件GET |
| RP | 515 | 2c6e73d043155b49.1 | RP-REGENERATE；列表重建 |
| RP | 523 | 9455978516828e94.1 | RP-DETAIL；export深链 |
| RP | 528 | 771186d2cb192900.1 | D-RP-EXPORT；导出生命周期 |
| RP | 528 | 92b76ba5cca9c487.1 | RP-CLOSE；Escape |
| RP | 535 | ec6fb3ba685c67a6.1 | RP-CLOSE；关闭按钮 |
| RP | 592 | 7ca6d136d071985b.1 | RP-REGENERATE；详情重建 |
| RP | 600 | 1c008f867673db60.2 | RP-TECH；导出错误码 |
...
| --- | --- |
| components/AutomationRuleCenter.vue | 7d753f4648d21dfa547063ce6ca431938ce0e67cbf05bbfabb414db571c06840 |
