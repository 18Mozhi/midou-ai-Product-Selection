...
| C资产/引用/login | 三表单自定义Tab、遮罩/Escape；closeEditor清两秘密字段并归还焦点；资产/轮换窗已有message和requestId（2026-09-09按实际模板更正） | 成功直接editor=null未走closeEditor；CSS隐藏控件未从焦点列表排除；仅引用窗缺少message渲染，其他窗实际反馈可感知性仍待验 |
