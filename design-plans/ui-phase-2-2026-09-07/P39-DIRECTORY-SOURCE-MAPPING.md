...
| apps/web/src/components/PlatformAccountDirectoryWorkspace.vue | 8871f6d994e9fced.1 | PA-ORG-DETAIL wiring；组织记录的 open-organization 事件转发，不生成第二个打开动作 |
| apps/web/src/components/PlatformAccountDirectoryWorkspace.vue | 44e761922e1da1d0.1 | PA43-DETAIL wiring；用户记录的 open-user 事件转发 |
...
| apps/web/src/components/PlatformAccountDirectoryWorkspace.vue | 103fa7d7798d62d6.1 | PA43-DETAIL wiring；管理员记录转发至同一用户详情入口 |
