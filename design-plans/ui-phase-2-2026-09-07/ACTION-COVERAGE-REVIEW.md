...
| [P25 审批中心](page-specs/P25.md) | 78 | [30组](action-reviews/P25.json) | 113个视觉状态槽待判断/映射；完整组合/真实Vue待验 |
...
尚有113个视觉状态槽未映射；已登记状态见逐项JSON，仍须判断所有变体适用性。有场景关联不等于每个按钮六态已验收，也不表示缺少同数量图片。
