...
| [P19 竞品监控](page-specs/P19.md) | 75 | [22组](action-reviews/P19.json) | 84个视觉状态槽待判断/映射；完整组合/真实Vue待验 |
| [P20 竞品监控规则](page-specs/P20.md) | 75 | [12组](action-reviews/P20.json) | 40个视觉状态槽待判断/映射；完整组合/真实Vue待验 |
...
尚有40个视觉状态槽未映射；已登记状态见逐项JSON，仍须判断所有变体适用性。有场景关联不等于每个按钮六态已验收，也不表示缺少同数量图片。
