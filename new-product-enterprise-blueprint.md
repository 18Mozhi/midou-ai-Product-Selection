...
- 当前自动层由 8 个市场 × 12 个主题的 96 个固定 Google News RSS 频道组成，覆盖新闻、电商、数据与社区讨论；Worker 为每个活动组织默认工作区循环自动调度，热点页也提供 `trend:read` 保护的立即刷新。
- Amazon、Keepa、1688、TikTok Shop、Reddit、YouTube、Similarweb、Semrush 等真实平台先登记为“待配置”。在官方凭证、接口合同或合规浏览器档案完成前保持禁用，不得把聚合新闻伪装成平台官方销量、价格或趋势。
